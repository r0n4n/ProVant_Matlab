...
%% UAV position 
affiche2({'x','y','z'},'input',{'SIL','HIL'})
legend('SIL','HIL')

%%
%% UAV position 
affiche2({'x','y','z'},'ref',{'SIL'})
%legend('SIL','HIL')


%% UAV attitude 

affiche2({'roll','pitch','yaw'},'input',{'SIL','HIL'})
legend('SIL','HIL')

%% Control Output 

affiche2({'Thrustdir','Thrustesq','RefaR','RefaL'},'output',{'SIL','HIL'})
legend('SIL','HIL')
